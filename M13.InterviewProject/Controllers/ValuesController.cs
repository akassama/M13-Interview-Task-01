...
namespace M13.InterviewProject.Controllers
{
    ...
    public class ValuesController : Controller
    {
        ...
        public ValuesController(HttpClientFactory clientFactory, ILogger<ValuesController> logger)
        {
        ...
        public object Get(string site)
        {
            ...
            {
                _logger.LogInformation("Get Site Error. " + ex.ToString());
        ...
        public string Test(string page, string rule = null)
        {
            ...
            try
            {
                ...
                text = _clientFactory.CreateClient().GetAsync("http://" + page)
                    .ContinueWith(t =>
                    {
            ...
            {
                _logger.LogInformation("Test Data Error. " + ex.ToString());
            }
            return text;
        }
        ...
        public void Delete(string site)
        {
            ...
            {
                _logger.LogInformation("Delete Site Error. " + ex.ToString());
            }
        }
        ...
        public IEnumerable<string> SpellErrors(string page)
        {
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogInformation("Get Spelling Error. " + ex.ToString());
            }
        ...
        public int SpellErrorsCount(string page)
        {
            ...
            {
                _logger.LogInformation("Count Spelling Error. " + ex.ToString());
            }
